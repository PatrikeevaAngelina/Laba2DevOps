...
pipeline {
    ...
    parameters {
        string(name: 'STUDENT_NAME', defaultValue: 'PatrikeevaAngelina', description: 'Имя студента')
        string(name: 'PORT', defaultValue: '0000', description: 'Порт')
    }
    ...
    stages {
        ...
        stage('Выгружаем код из репозитория') {
            steps {
               git 'https://github.com/PatrikeevaAngelina/DevOpsLab2.git'
            }
        }
